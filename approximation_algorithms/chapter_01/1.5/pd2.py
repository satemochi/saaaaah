...
if __name__ == '__main__':
    n, el, ep = experiment()
    print n, el, ep
    plt.plot(n, el, marker='o', label='linear relaxation')
    plt.plot(n, ep, marker='o', label='primal-dual')
    plt.xticks(n)
    plt.gca().set_xlabel('n')
    plt.gca().set_ylabel('sec')
    plt.legend(loc='best')
    plt.savefig('running_time_experiments.png', bbox_inches='tight')
    plt.show()
